...
class FlutterMentions extends StatefulWidget {
  ...
  /// Callback when the user taps outside the input box.
...
class FlutterMentionsState extends State<FlutterMentions> {
  ...
  void addMention(Map<String, dynamic> value, [Mention? list]) {
    ...
    final _list =
        widget.mentions.firstWhere((element) => selectedMention.str.contains(element.trigger));
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: PortalTarget(
        anchor: widget.suggestionPosition == SuggestionPosition.Bottom
            ...
            return show && !widget.hideSuggestionList
                ? OptionList(
                    ...
                    data: list.data.where((element) {
                      ...
                      final str =
                          _selectedMention!.str.toLowerCase().replaceAll(RegExp(_pattern), '');
